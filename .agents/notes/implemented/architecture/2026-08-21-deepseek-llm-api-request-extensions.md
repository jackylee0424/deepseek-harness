...
[Remove remote telemetry](../simplification/2026-09-02-remove-remote-telemetry.md) withdrew the user/session request headers and the OpenTelemetry backend; this request path never carried either, and the default-off inventory row is part of that decision.
